...
class Pokemon {
    ...
    func downloadPokemonDetails(completed: DownloadComplete) {
        ...
        let url = NSURL(string: _pokemonUrl)!
            ...
            if let dict = dictResult.value as? Dictionary<String, AnyObject> {
                    ...
                    if moves.count > 1 {
                        for var x = 1; x < 5; x++ {
                            if let move = moves[x]["name"] {
                                self._move! += " / \(move.capitalizedString) "
                            }
                        }
                    }
               ...
               print(self._move)
                        ...
                        Alamofire.request(.GET, nsurl).responseJSON { response in
                            ...
                            if let descDict = descResult.value as? Dictionary<String, AnyObject> {
                                ...
                                if let description = descDict["description"] as? String {
                                    self._description = description.stringByReplacingOccurrencesOfString("POKMON", withString: "POKEMON").stringByReplacingOccurrencesOfString("con vert", withString: "convert")
                ...
                if let evolutions = dict["evolutions"] as? [Dictionary<String,AnyObject>] where evolutions.count > 0 {
                    ...
                    if let to = evolutions[0]["to"] as? String {
                        ...
                        //Support for Mega Pokemon Not Extablished at this time
